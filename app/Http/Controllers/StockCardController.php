...
class StockCardController extends Controller {
	...
	public function create(Request $request)
	{
		...
		$source_destination_list = UNHLSFacility::orderBy('name', 'ASC')->pluck('name', 'id')->toArray();
		...
		if(Session::get('action')== config('constants.INCOMING_STOCK_FLAG') )
		{
			...
			{
				$source_destination_list = UNHLSWarehouse::orderBy('name', 'ASC')->pluck('name', 'id')->toArray();
