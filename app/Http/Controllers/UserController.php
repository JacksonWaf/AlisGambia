...
class UserController extends Controller
{
    ...
    public function home()
    {
        ...
        return view('user.login', compact('hubs'));
    }
    ...
    public function index()
    {
        ...
        $users = User::orderBy('name', 'ASC')->where('facility_id', $facility)->get();
    ...
    public function update(Request $request, $id)
    {
        //
        $rules = array(
            'username' => 'required:users,username|min:4',
            'full_name' => 'required'
        );
