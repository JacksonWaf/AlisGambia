...
class DashboardController extends Controller {
	...
	public function index(Request $request){
        ...
        $patients = UnhlsVisit::whereBetween('unhls_visits.created_at', [$from, $to])->leftjoin('unhls_patients', 'unhls_patients.id', '=', 'unhls_visits.patient_id')->where('unhls_patients.hubid', Auth::user()->facility->id);
