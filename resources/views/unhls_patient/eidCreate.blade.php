	...
	<div class="panel-body">
		...
		<div class="form-group col-md-12">
			...
			<div class="col-md-4">
				...
				{{ Form::text('health_unit', strtoupper(Auth::user()->facility->name), array('class' => 'form-control')) }}
			</div>
		</div>
		...
		<div class="form-group col-md-12">
			...
			<div class="col-md-4">
				...
				<div>{{ Form::radio('breastfeeding', '1', true) }}
					<span class="input-tag">{{"Yes"}}</span>
				</div>
				<div>{{ Form::radio("breastfeeding", '0', false) }}
					<span class="input-tag">{{"No"}}</span>
				</div>
			</div>
		</div>
					...
					<div class="form-group col-md-12">
						<div class="col-md-4">
							...
							<div>{{ Form::radio('pcr', '1') }}
								<span class="input-tag">{{"Ist PCR"}}</span>
							</div>
							<div>{{ Form::radio("pcr", '0') }}
								<span class="input-tag">{{"2nd PCR"}}</span>
							</div>
						</div>
						...
						<div class="col-md-4">
							...
							<div>{{ Form::radio('non_routine_pcr', '1') }}
								<span class="input-tag">{{"R1"}}</span>
							</div>
							<div>{{ Form::radio("non_routine_pcr", '0') }}
								<span class="input-tag">{{"R2"}}</span>
							</div>
						</div>
						...
						<div>
							<p><strong>Note:</strong> R1 = Any repeat before 2nd PCR <br>
								<strong>R2</strong> = Any repeat after 2nd PCR before 18 months. <br>
								<strong>2nd PCR </strong>is done 6 weeks after cessation of breastfeeding
							</p>
						</div>
