    ...
    <div class="panel-body">
        <table class="table table-striped table-hover table-condensed">
            ...
            <tbody>
                ...
                <tr @if(Session::has('activepatient')) {{(Session::get('activepatient') == $patient->id)?"class='info'":""}} @endif>
                    ...
                    <td>
                        <!-- can create visit -->
                        <a class="btn btn-sm btn-info" href="{{ route('unhls_test.create', array('patient_id' => $patient->id)) }}">
