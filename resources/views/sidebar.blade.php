...
<nav id="side_nav">
 ...
 -->
            ...
            <div class="sub_panel" style="left: -220px;">
                <div class="side_inner ps-ready ps-container" style="height: 620px;">
                    ...
                    <ul>
                        ...
                        <li>
                            <div>
                                <a href="{{ route('viral.create') }}">
                                    <span class="glyphicon glyphicon-tag"></span> {{"Register VL patient"}}</a>
                            </div>
                        </li> -->
        ...
        @can('manage_visits')
        <!-- <li>
            <a href="{{ route('visit.index') }}"><span class="ion ion-person"><span class="nav_title">Visits</span></span>
            </a>
        </li> -->
        @endcan
        <li class="nav_trigger">
            ...
            <div class="sub_panel" style="left: -220px;">
                <div class="side_inner ps-ready ps-container" style="height: 620px;">
                    ...
                    @can('manage_upload')
                    <h4 class="panel_heading panel_heading_first"> Downloads</h4>
                    <ul>
                        <!-- <li>
                                <div>
                        ...
                        <li>
                            <div>
                                <a href="{{route('reports.export.alis_restrack_data')}}">
                                    <span class="glyphicon glyphicon-tag"></span>{{trans('Download ALIS-RESTRACK DATA')}}
                                </a>
                            </div>
                        </li>
                        ...
                        <!-- <li>
                            <div>
                                <a href="{{URL::route('vl.vl_data_view')}}">
                ...
                <div class="side_inner ps-ready ps-container" style="height: 620px;">
                    ...
                    <ul>
                        ...
                        <li>
                            <div>
                                <a href="{{ route("resetulin.create")}}">
                                    <span class="glyphicon glyphicon-tag"></span> {{trans('Upload Stamps')}}</a>
                            </div>
                        </li>
                        <li>
                            <div>
                                <a href="{{ route("resetulin.create")}}">
                                    <span class="glyphicon glyphicon-tag"></span> {{trans('Upload Signature')}}</a>
                            </div>
                        </li>
                    </ul>
