	...
	<div class="panel-body">
		...
		<fieldset>
			<h1 class="panel-title" style="text-align:center">{{ HTML::image(Config::get('kblis.organization-logo'),  Config::get('kblis.country') . trans('messages.court-of-arms'), array('width' => '150px')) }}
				<br>
				<strong>{{ strtoupper(Config::get('constants.FACILITY_REQUEST_FORM_HEADER')) }}</strong>
			</h1>
			<br>
			<br>
			...
			<div class="panel panel-warning">
				...
				<div class="form-inline">
					...
					<div class="form-group">
						...
						<div class="radio-inline">{{ Form::radio("intervention_authority", 'NPHL', false) }} <span class="input-tag">NPHL</span></div>
					</div>
					<br>
