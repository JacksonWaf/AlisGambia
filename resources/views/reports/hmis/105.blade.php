...
<div class="panel panel-primary">
	<div class="panel-heading ">
		...
		HMIS Report |
		<a title="Previous Month" href="{{URL::to('/hmis105/'.date('Y-m',strtotime(date('Y-m',strtotime($month)).' -1 month')))}}">
			<span class="btn btn-default ion-android-arrow-back"></span></a>
		{{date('Y-M',strtotime($month))}}
		<a title="Next Month" href="{{URL::to('/hmis105/'.date('Y-m',strtotime(date('Y-m',strtotime($month)).' +1 month')))}}">
			...
			<table class="table table-condensed report-table-border">
				<tbody>
					...
					<tr>
						...
						<td colspan="2">
							{{(isset($testTypeCountArray['hepatitis_b']['hepatitis_b']))?$testTypeCountArray['hepatitis_b']['hepatitis_b']['total']:''}}
						</td>
						<td colspan="2">
							{{(isset($testTypeCountArray['hepatitis_b']['hepatitis_b']))?$testTypeCountArray['hepatitis_b']['hepatitis_b']['positive']:''}}
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2">
							{{(isset($testTypeCountArray['uric_acid']['uric_acid']))?$testTypeCountArray['uric_acid']['uric_acid']['total']:''}}
						</td>
						<td colspan="2">
							{{(isset($testTypeCountArray['uric_acid']['uric_acid']))?$testTypeCountArray['uric_acid']['uric_acid']['positive']:''}}
						</td>
					</tr>
					<tr>
