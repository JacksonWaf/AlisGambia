        ...
        <div class="panel-body">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    {{ Form::select('storage-condition', ['' => '--- Select storage type ---','1' => 'Cold Chain','2' => 'Room Temp', '3' => 'Other']) }}
                </div>
                ...
                <div class="form-group">
                    ...
                    {{ Form::select('referral-reason', array(0 => '')+$referralReason->pluck('reason', 'id')->toArray(),
                ...
                <div class="form-group">
                    ...
                    {{ Form::select('facility_id', array(0 => '')+$facilities->pluck('name', 'id')->toArray(), old('facility_id'),
                        array('class' => 'form-control')) }}
                </div>
                <div class="form-group">
