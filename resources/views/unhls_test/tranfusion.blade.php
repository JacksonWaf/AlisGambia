             ...
             <div class="container-fluid">
                <div class="col-md-12">
                    <div class="panel panel-info">  <!-- Patient Details -->
                        <div class="panel-heading">
                            <h3 class="panel-title">{{trans("Upload CBC - XN-550 Results Files (CSV)") }}</h3>
                        </div>
                        {{ Form::open(array('route' => array('unhls_test.upload',$test->id), 'method' => 'POST',
                            'files' => true)) }}
                        <div class="panel-body">
                            <div class="container-fluid">
                                <div class="form-group">
                                    {{ Form::label('results', trans('Upload Results File')) }}
                                    {{ Form::file('results', ['class' => 'form-control']) }}
                                </div>
                                <div class="form-group actions-row">
                                    {{ Form::button('<span class="glyphicon glyphicon-save"></span> '.trans('Upload File'),
