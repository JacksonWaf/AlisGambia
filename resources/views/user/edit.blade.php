					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="active">
							<a href="#edit-profile" role="tab" data-toggle="tab">
								{{trans('messages.edit-profile')}}</a>
						</li>
						<li>
							<a href="#change-password" role="tab" data-toggle="tab">
								{{trans('messages.change-password')}}</a>
						</li>
					</ul>
					<br />
					@endif
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-md-8">
										...
										<div class="form-group">
											<label for="reset-password"><a class="reset-password" href="javascript:void(0)">{{trans('messages.reset-password')}}
											</label></a>
									...
									<div class="col-md-4">
										<div class="profile-photo">
											...
											<div class="form-group">
												<img class="img-responsive img-thumbnail user-image" src="" alt="{{trans('messages.image-alternative')}}"></img>
											</div>
											@else
											<div class="form-group">
