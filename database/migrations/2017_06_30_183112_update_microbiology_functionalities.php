...
class UpdateMicrobiologyFunctionalities extends Migration
{
    ...
    public function up()
    {
        ...
        $districtsData = array(
            array(
                "id" => config('constants.DISTRICT_ID'),
        ...
        $testTypeCategoryTransfusion = TestCategory::create(array("name" => "CLINICAL CHEMISTRY", "description" => ""));
        ...
        MeasureRange::create(array("measure_id" => $measureBloodGroup->id, "alphanumeric" => "AB+"));
        $measureHB = Measure::create(array(
            "measure_type_id" => Measure::NUMERIC, "name" => "HB",
            "unit" => "g/dL"
        ));
        ...
        $measuresWBCData = array(
            array(
                "measure_type_id" => Measure::NUMERIC, "name" => "WBC",
                "unit" => "x10³/µL"
            ),
        ...
        $measureRangesWBC = array(
            array(
                "measure_id" => $measuresWBC[0]->id, "age_min" => 0, "age_max" => 100, "gender" => MeasureRange::BOTH,
                "range_lower" => 4, "range_upper" => 11
            ),
            array(
                "measure_id" => $measuresWBC[1]->id, "age_min" => 0, "age_max" => 100, "gender" => MeasureRange::BOTH,
                "range_lower" => 1.5, "range_upper" => 4
            ),
            array(
                "measure_id" => $measuresWBC[2]->id, "age_min" => 0, "age_max" => 100, "gender" => MeasureRange::BOTH,
                "range_lower" => 0.1, "range_upper" => 9
            ),
            array(
                "measure_id" => $measuresWBC[3]->id, "age_min" => 0, "age_max" => 100, "gender" => MeasureRange::BOTH,
                "range_lower" => 2.5, "range_upper" => 7
            ),
            array(
                "measure_id" => $measuresWBC[4]->id, "age_min" => 0, "age_max" => 100, "gender" => MeasureRange::BOTH,
                "range_lower" => 0, "range_upper" => 6
            ),
            array(
                "measure_id" => $measuresWBC[5]->id, "age_min" => 0, "age_max" => 100, "gender" => MeasureRange::BOTH,
        ...
        DB::insert(
            'INSERT INTO testtype_specimentypes (test_type_id, specimen_type_id) VALUES (?, ?)',
        ...
        $measureWBC = Measure::create([
            "measure_type_id" => Measure::NUMERIC,
        ...
        $testTypeCBC = TestType::create(array(
            "name" => "CBC", "test_category_id" => $testTypeCategoryHematology->id,
            "orderable_test" => 1
        ));
