<?php $__env->startSection("content"); ?>
	...
	<div>
		<ol class="breadcrumb">
		  ...
		  <li class="active"><a href="<?php echo e(route('testnamemapping.show',[$measureNameMapping->test_name_mapping_id])); ?>">Measure Name Mapping</a></li>
	...
	<div class="panel panel-primary">
		...
		<!-- if there are creation errors, they will show here -->
			...
			<?php echo e(Form::model($measureNameMapping, array('route' => ['measurenamemapping.update', $measureNameMapping->id],
				'method' => 'PUT', 'id' => 'form-add-testnamemapping'))); ?>

				<div class="form-group">
					<?php echo e(Form::label('measure_id', 'Measure')); ?>

					<?php echo e(Form::select('measure_id', $measures,
...
<?php echo $__env->make("layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/alis_gambia/resources/views/testnamemapping/measurenamemapping/edit.blade.php ENDPATH**/ ?>