	...
	<div class='row spacer'>
		<div class="col-sm-12">
	    	<div class="row">
				...
				<div class="col-sm-3">
				    <label class="radio-inline">
						<?php echo e(Form::radio('counts', trans('messages.ungrouped-specimen-counts'), true, array('data-toggle' => 'radio',
...
<div class="panel panel-primary">
	...
	<?php endif; ?>
	<strong>
		<p> <?php echo e(trans('messages.ungrouped-specimen-counts')); ?> -
		...
		<div class="table-responsive">
		  <table class="table table-striped table-bordered">
		    <tbody>
			    <tr>
			    	<th><?php echo e(Lang::choice('messages.specimen-type',2)); ?></th>
			    	<th><?php echo e(trans('messages.specimen-accepted')); ?></th>
			    	<th><?php echo e(trans('messages.specimen-rejected')); ?></th>
			    	<th><?php echo e(trans('messages.total-specimen')); ?></th>
			    </tr>
			    <?php $__empty_1 = true; $__currentLoopData = $ungroupedSpecimen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

			    <tr>
			    	<td><?php echo e(App\Models\SpecimenType::find($key)->name); ?></td>
			    	<td><?php echo e($value['accepted']); ?></td>
			    	<td><?php echo e($value['rejected']); ?></td>
...
<?php echo $__env->make("layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/alis_gambia/resources/views/reports/counts/ungroupedSpecimenCount.blade.php ENDPATH**/ ?>