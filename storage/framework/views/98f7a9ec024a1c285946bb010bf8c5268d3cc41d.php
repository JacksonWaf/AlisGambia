	...
	<div class='row spacer'>
		<div class="col-sm-12">
	    	<div class="row">
				...
				<div class="col-sm-3">
					<label class="radio-inline">
			    		<?php echo e(Form::radio('counts', trans('messages.grouped-specimen-counts'), true, array('data-toggle' => 'radio',
...
<div class="panel panel-primary">
	...
	<?php endif; ?>
	<strong>
		<p> <?php echo e(trans('messages.grouped-specimen-counts')); ?> -
		  ...
		  <table class="table table-striped table-bordered">
		  	<tbody>
		  		<tr>
		  			...
		  			<th rowspan="2"><?php echo e(trans('messages.total-specimen')); ?></th>
		  		</tr>
		  		<tr>
		  		...
		  		<?php $__empty_1 = true; $__currentLoopData = $specimenTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specimenType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
		  		<tr>
			  		...
			  		<?php $__currentLoopData = $ageRanges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ageRange): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			  			<td>
							<?php echo e($perAgeRange[$specimenType->id][$ageRange]["male"]); ?><br /><?php echo e($perAgeRange[$specimenType->id][$ageRange]["female"]); ?><br />
						</td>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					<td>
						<?php echo e($perSpecimenType[$specimenType->id]['countMale']); ?><br /><?php echo e($perSpecimenType[$specimenType->id]['countFemale']); ?><br />
			  		</td>
			  		<td><?php echo e($perSpecimenType[$specimenType->id]['countAll']); ?></td>
			  	</tr>
			  	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
			  	<tr>
			  		<td><?php echo e(trans('messages.no-records-found')); ?></td>
			  	</tr>
			  	<?php endif; ?>
		  	</tbody>
		  </table>
...
<?php echo $__env->make("layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/alis_gambia/resources/views/reports/counts/groupedSpecimenCount.blade.php ENDPATH**/ ?>