...
Route::middleware('api')->group(function () {
    ...
    */
    ...
    Route::get("/getpatientdetails/{barcode}", array(
        "as"   => "patient.getpatientdetails",
        "uses" => "UnhlsTestController@getpatientdetails"
    ));
    ...
    Route::any("/patient_interim_report_stracker/{id}/{visit}", array(
        "as" => "reports.patientinterimreportstracker",
